...
cd ../
minimap2_fpga_param_search/minimap2_fpga -x $mm2_config -t 1 $reference $reads > /dev/null 2> param_data_file.txt
check_error "Run failed. Check minimap2_fpga_param_search/param_data_file.txt for details."
