...
static ko_longopt_t long_options[] = {
	{ (char *)"bucket-bits",    ko_required_argument, 300 },
	{ (char *)"mb-size",        ko_required_argument, 'K' },
	{ (char *)"seed",           ko_required_argument, 302 },
	{ (char *)"no-kalloc",      ko_no_argument,       303 },
	{ (char *)"print-qname",    ko_no_argument,       304 },
	{ (char *)"no-self",        ko_no_argument,       'D' },
	{ (char *)"print-seeds",    ko_no_argument,       306 },
	{ (char *)"max-chain-skip", ko_required_argument, 307 },
	{ (char *)"min-dp-len",     ko_required_argument, 308 },
	{ (char *)"print-aln-seq",  ko_no_argument,       309 },
	{ (char *)"splice",         ko_no_argument,       310 },
	{ (char *)"cost-non-gt-ag", ko_required_argument, 'C' },
	{ (char *)"no-long-join",   ko_no_argument,       312 },
	{ (char *)"sr",             ko_no_argument,       313 },
	{ (char *)"frag",           ko_required_argument, 314 },
	{ (char *)"secondary",      ko_required_argument, 315 },
	{ (char *)"cs",             ko_optional_argument, 316 },
	{ (char *)"end-bonus",      ko_required_argument, 317 },
	{ (char *)"no-pairing",     ko_no_argument,       318 },
	{ (char *)"splice-flank",   ko_required_argument, 319 },
	{ (char *)"idx-no-seq",     ko_no_argument,       320 },
	{ (char *)"end-seed-pen",   ko_required_argument, 321 },
	{ (char *)"for-only",       ko_no_argument,       322 },
	{ (char *)"rev-only",       ko_no_argument,       323 },
	{ (char *)"heap-sort",      ko_required_argument, 324 },
	{ (char *)"all-chain",      ko_no_argument,       'P' },
	{ (char *)"dual",           ko_required_argument, 326 },
	{ (char *)"max-clip-ratio", ko_required_argument, 327 },
	{ (char *)"min-occ-floor",  ko_required_argument, 328 },
	{ (char *)"MD",             ko_no_argument,       329 },
	{ (char *)"lj-min-ratio",   ko_required_argument, 330 },
	{ (char *)"score-N",        ko_required_argument, 331 },
	{ (char *)"eqx",            ko_no_argument,       332 },
	{ (char *)"paf-no-hit",     ko_no_argument,       333 },
	{ (char *)"split-prefix",   ko_required_argument, 334 },
	{ (char *)"no-end-flt",     ko_no_argument,       335 },
	{ (char *)"hard-mask-level",ko_no_argument,       336 },
	{ (char *)"cap-sw-mem",     ko_required_argument, 337 },
	{ (char *)"max-qlen",       ko_required_argument, 338 },
	{ (char *)"max-chain-iter", ko_required_argument, 339 },
	{ (char *)"junc-bed",       ko_required_argument, 340 },
	{ (char *)"junc-bonus",     ko_required_argument, 341 },
	{ (char *)"sam-hit-only",   ko_no_argument,       342 },
	{ (char *)"chain-gap-scale",ko_required_argument, 343 },
	{ (char *)"alt",            ko_required_argument, 344 },
	{ (char *)"alt-drop",       ko_required_argument, 345 },
	{ (char *)"mask-len",       ko_required_argument, 346 },
	{ (char *)"help",           ko_no_argument,       'h' },
	{ (char *)"max-intron-len", ko_required_argument, 'G' },
	{ (char *)"version",        ko_no_argument,       'V' },
	{ (char *)"min-count",      ko_required_argument, 'n' },
	{ (char *)"min-chain-score",ko_required_argument, 'm' },
	{ (char *)"mask-level",     ko_required_argument, 'M' },
	{ (char *)"min-dp-score",   ko_required_argument, 's' },
	{ (char *)"sam",            ko_no_argument,       'a' },
	{ 0, 0, 0 }
};
